...
export function SchoolCard({
  ...
  return (
    (<button
      ...
      className={cn(
        "w-full text-left hover:outline-none focus:outline-none hover:ring-0 focus:ring-0 active:ring-0 hover:transform hover:scale-110 transition-transform duration-300",
        className
      )}>
      <Card
