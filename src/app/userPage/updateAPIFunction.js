...
export default async function updateAPIFunctionName(documentId, newValue, token) {
...
export async function updateAPIFunctionDescription(documentId, newValue, token) {
  ...
  export async function updateAPIFunctionLocation(documentId, newValue, token) {
  ...
  export async function updateAPIFunctionImage(documentId, newValue, token) {
  ...
  export async function updateAPIFunctionUrl(documentId, newValue, token) {
  ...
  export async function updateTags(documentId, newValue, token) {
...
export async function updateRemoveTag(documentId, tag, token) {
